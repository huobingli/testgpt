...
# 这里你需要改为自己的实际文件夹路径
tokenizer = GPT2Tokenizer.from_pretrained('D:/work/gpt/model/gpt2')
# text = 'What is iPhone ? iPhone is a'
text = 'which person designed iPhone ? iPhone is designed by'
# 编码一段文本
...
# 从下载好的文件夹中加载预训练模型
model = GPT2LMHeadModel.from_pretrained('D:/work/gpt/model/gpt2')
